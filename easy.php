...
<head>
    ...
    <title>Easy - Guess the Number</title>
...
<body>
    ...
    <div>
        <img class="banner" src="Images/Easy_Banner.png" alt="Banner">
    </div>

    <h2>Welcome <?php echo $_SESSION['nickname']?></h2>
    <h2>Goodluck and Have Fun!</h2>
    <form action="easy_function.php" method="post">
        <table>
            <tr>
                <th colspan="2">Guess the number from 1 to 5</th>
            </tr>
            <tr>
