...
<head>
    ...
    <title>Medium - Guess the Number</title>
...
<?php
    ...
    <div>
        <img class="banner" src="Images/Medium_Banner.png" alt="Banner">
    </div>

    <h2>Welcome <?php echo $_SESSION['nickname']?></h2>
    <h2>Goodluck and Have Fun!</h2>
    <form action="medium_function.php" method="post">
    <table>
            <tr>
                <th colspan="2">Guess the number from 1 to 10</th>
            </tr>
            <tr>
